...
$alumno = new Alumno($_SESSION['id_persona'],$id_colegio);
      ...
      <nav class="menu-block">
        ...
        <ul class="nav">
          ...
          <li class="menu-block-has-sub nav-item"><a href="#" class="nav-link"> <i class="icon ion-university"></i>
              <div class="menu-block-label">Calificaciones</div></a>
            <ul class="nav menu-block-sub">
              <li class="nav-item"><a href="calificaciones.php" class="nav-link">Calificaciones</a></li>
             
            </ul>
          </li>
          <li class="menu-block-has-sub nav-item"><a href="#" class="nav-link"> <i class="icon ion-ios-paper-outline"></i>
              <div class="menu-block-label">Tareas</div></a>
            <ul class="nav menu-block-sub">
              <li class="nav-item"><a href="Tareas.php" class="nav-link">Tareas</a></li>
            ...
            <div class="panel">
              <div class="panel-body">
                ...
                <div id="datos_alumno">
                    ...
                    <div class="dato_alumno">
                        <label>Grado: </label>
                        <div class="value"><?php echo " ".$alumno->grado; ?></div>
                    </div>
                    <div class="dato_alumno">
                        <label>Grupo: </label>
                        <div class="value"><?php echo " ".$alumno->grupo; ?></div>
                    </div>
                </div>
