...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0"/>
        <title>Sistema Integral Meze - Asignar Tareas</title>
	<!-- lib-->
            ...
            <div class="col-md-4">
              <div class="media">
                <div class="media-body">
                  <div class="display-6">Asignar Tareas</div>
          ...
          <div class="panel-wrapper">
            <div class="panel">
              <div class="panel-body">
				<div id="principal">
					 <iframe src="asignartarea.php" frameborder="0" width="900" height="500"></iframe>		
				</div><!--fin principal-->
		 </div><!--fin panel-body-->
            </div>
          </div>
