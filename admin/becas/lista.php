...
<html lang="en">
    ...
    <title>Sistema Integral MEZE - Becas</title>
            ...
            <div class="col-md-4">
              <div class="media">
                <div class="media-body">
                  <div class="display-6">Lista de Alumnos con Beca</div>
                            ...
                            foreach($becas as $beca)
                            {
                                echo "
                                    <tr>
                                        ...
                                        <td>
                                            <a href='../alumnos/perfil.php?id_alumno=".$beca['id_persona']."' >".$beca['alumno']."</a>
                                        </td>
                                        <td>".$beca['usuario']."</td>
                                        <td>".$beca['beca']."</td>
                                        <td>".$beca['tipo']."</td>
