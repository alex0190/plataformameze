      ...
      <div class="view-wrapper">
        ...
        <div class="container-fluid">
          <div class="panel-wrapper">
            ...
            Pago por el concepto de colegiatura es por la cantidad de
                <div id="monto_a_pagar" style="float: left; margin-left: 4px;"></div>
            

			<div class="boton">
             <input type="button" class="form_submit btn btn-primary" value="Aceptar" id="boton" onClick="pagar();" disabled />
            </div>
        </div><!--area_trabajo-->
