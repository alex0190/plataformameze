...
$colegios = Colegio::getLista();
?>
    <link rel="shortcut icon" href="../../images/logo.ico">
    <meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0"/>
    <title>Sistema Integral MEZE - Colegios</title>
            ...
            <div class="col-md-4">
              <div class="media">
                <div class="media-body">
                  <div class="display-6">Lista de Colegios Registrados</div>
                                ...
                                foreach($colegios as $colegio)
                                {
                                    echo "
                                        <tr>
											...
											<td><img src='../../media/imglogo/$colegio[Imagen]' id='foto_colegio' width='20' height='20'/></td>
                                            <td>
                                                <a href='perfil.php?id_colegio=".$colegio['IDColegio']."' >
                                                    <img src='../../media/iconos/icono-colegio.png' alt='P' width='20' height='20'/>
                                                </a>
                                            </td>
                                         </tr>
                                    ";
