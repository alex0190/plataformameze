...
<head>
    ...
    <title>Sistema Integral Meze - Configuración: Cuentas Dinamicas</title>
        ...
        <ul class="nav">
		  ...
		  <li class="menu-block-has-sub nav-item"><a href="#" class="nav-link"> <i class="icon ion-settings"></i>
            ...
            <ul class="nav menu-block-sub">
              ...
              <li class="nav-item"><a href="../colonias/index.php" class="nav-link">Colonias</a></li>
			  ...
			  <li class="nav-item"><a href="index.php" class="nav-link">Cuentas Dinamicas</a></li>
            </ul>
          </li>
        </ul>
        <!-- END SITE MAINMENU-->
            ...
            <div class="col-md-4">
              <div class="media">
                <div class="media-body">
                  <div class="display-6">Cuentas Dinamicas</div>
