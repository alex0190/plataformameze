...
<head>
    ...
    <title>Sistema Integral MEZE - Asistencias</title>
      ...
      <div class="view-wrapper">
            ...
            <div class="col-md-4">
              <div class="media">
                <div class="media-body">
                  <div class="display-6">Maestros Activos en el Ciclo Escolar</div>
        ...
        <div class="container-fluid">
          <div class="panel-wrapper">
            ...
            <table id="tabla_asistencias" class="table" data-plugin="DataTable">
                <thead>
                <tr>
                    <th>Docente</th>
