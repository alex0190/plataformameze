...
<html lang="en">
    ...
    <title>Sistema Integral MEZE - Alumnos Inscritos</title>
            ...
            <div class="col-md-4">
              <div class="media">
                <div class="media-body">
                  <div class="display-6">Lista de Alumnos Inscritos</div>
              ...
              <div class="panel-body">
				<div id="principal" >
        			<div id="area_trabajo">
						<div id="selector_ciclo">
							...
							<select id="ciclo_escolarVal" onchange="cargarAlumnos()" class="form-control">
								<?php
									...
									$id_actual = CicloEscolar::getActual($id_colegio);
                        ...
                        <br>
						<table id="tabla_alumnos" class="table" data-plugin="DataTable">
							<thead>
								<tr>
									<th>Matricula</th>
	...
	<script>
        ...
        function declararDataTable()
        {
            tabla_alumnos = $('#tabla_alumnos').dataTable({
                "oLanguage": {
                    "sLengthMenu": "Mostrar _MENU_ alumnos por p&aacute;gina",
