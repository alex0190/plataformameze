        ...
        <ul class="nav">
          ...
          <li class="menu-block-has-sub nav-item"><a href="#" class="nav-link"> <i class="icon ion-ios-book"></i>
            ...
            <ul class="nav menu-block-sub">
              <li class="nav-item"><a href="../colegios/index.php" class="nav-link">Ver Todos</a></li>
              <li class="nav-item"><a href="../colegios/nuevo.php" class="nav-link">Nuevo</a></li>
            </ul>
          </li>
            ...
            <div class="col-md-4">
              <div class="media">
                <div class="media-body">
                  <div class="display-6">Lista de Administradores Registrados</div>
