...
class Maestro extends Persona
{
    ...
    {
        return Database::select("SELECT * FROM persona WHERE tipo_persona = 2 AND IDColegio = '$id'");
    }

    static function getListaVigentes($id)
    {
        return Database::select("SELECT *, CONCAT(nombres, ' ', apellido_paterno, ' ', apellido_materno) AS nombre
            FROM persona WHERE tipo_persona = 2 AND (ISNULL(fecha_baja) OR fecha_baja > NOW()) AND IDColegio = '$id'");
    }
    ...
    public static function insert($apellido_paterno, $apellido_materno, $nombres, $sexo, $idcolegio)
    {
        ...
        $query = "INSERT INTO persona
            ...
            2, '$password', NOW(), null, 'photo_NA.jpg', '$sexo', $idcolegio FROM persona
