...
class Area
{
    ...
    {
        return Database::select("SELECT * FROM area WHERE IDColegio = '$id'");
    }

    static function insert($nombre, $prefijo, $no_parciales, $idcolegio)
    {
        $query = "INSERT INTO area SET area = '$nombre', prefijo = '$prefijo', no_parciales = '$no_parciales', IDColegio = '$idcolegio'";
