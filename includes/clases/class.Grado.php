...
class Grado
{
    ...
    function __construct($id_grado)
    {
		...
		$this->id_colegio = $grado['IDColegio'];
    }
    ...
    {
        $ciclo_actual = CicloEscolar::getActual($this->id_colegio);
    ...
    {
        $ciclo_escolar = CicloEscolar::getActual($this->id_colegio);
    ...
    {
        return Database::select("SELECT grado.*, area FROM grado JOIN area ON grado.id_area = area.id_area WHERE grado.IDColegio = '$id'");
    }

    static function insert($ciclo, $area, $grado, $materias, $idcolegio)
    {
        $id_grado = Database::insert("INSERT INTO grado SET grado = '$grado', id_area = '$area', IDColegio = '$idcolegio'");
